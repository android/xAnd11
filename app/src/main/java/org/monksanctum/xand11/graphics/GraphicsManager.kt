...
class GraphicsManager {
    ...
    private val mGcs = SparseArray<GraphicsContext>()
    private val mPixmaps = SparseArray<Pixmap>()
    private val mDrawableLookup = SparseArray<XDrawable>()
    ...
    companion object {
        ...
        val DEBUG = XService.GRAPHICS_DEBUG
    }
}
